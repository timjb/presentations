...
\begin{bem}
  ...
  Dann gibt es eine Kategorienäquivalenz $\SetC/B \equiv \FuncC{\Bat}{\SetC} \equiv \FuncC{\Bat^\op}{\SetC}$ gegeben durch
  \[
...
\[
  ...
  \right\}
\]
(Interpretation: Elemente von $W$ sind Graphen~$G$ eines auf der Faser $Y_b$ definierten Morphismus in die Faser $Z_b$.)
\qedhere
...
TODO: geometrische Aussagen transportieren (?)
